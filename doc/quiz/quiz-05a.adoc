:sourcedir: ../../example/network/src/main/java/com/nhnacademy/quiz
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="newSocket",indent=0]
----
+
* 연결에 성공하면, 메시지가 출력된다.
+
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="connected",indent=0]
----
+
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="IOException",indent=0]
----
+
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="getInputStream",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="getOutputStream",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="inputRead",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="exit",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="outputWrite",indent=0]
----
* 수신된 데이터 만큼만 출력한다.
+
...
[source,java]
----
include::{sourcedir}/Quiz05.java[tags="socketClose",indent=0]
----
--
+
...
[source,java]
----
include::{sourcedir}/Quiz05.java[데이터 보내기]
----
