...
[source,java]
----
include::{sourcedir}/Quiz04.java[tags="createSocket",indent=0]
----
+
...
[source,java]
----
include::{sourcedir}/Quiz04.java[tags="readLine",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz04.java[tags="outputWrite",indent=0]
----
+
...
[source,java]
----
include::{sourcedir}/Quiz04.java[tags="closeSocket",indent=0]
----
...
[source,java]
----
include::{sourcedir}/Quiz04.java[데이터 보내기]
----
